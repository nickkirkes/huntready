...
**Current Milestone:** M1 — Montana Ingestion (E01 + E02 complete; E03 active — 12/14 stories complete: S03.0-S03.9 + S03.6.1 + S03.10 first cross-cutting binding loader (code-complete 2026-05-26; ~870 LOC; 18 fail-loud guards; reuses `db.upsert_jurisdiction_binding` from S03.6.1; T16 live UAT operator-pending — does NOT gate S03.11/S03.12 planning). 2 stories remain: S03.11 (calibration audit) + S03.12 (M1 UAT + handoff).)
...
| E03 | Montana Regulation Text Ingestion | In Progress (12/14 — S03.10 code-complete 2026-05-26; T16 live UAT operator-pending; S03.11 + S03.12 remain) | 2026-05-03 | — | 14 (13 original + S03.6.1) |
...
- **Begin S03.11 (Confidence calibration audit + ADR-017 finalization) — UNBLOCKED.** S03.10 produces no audit signal (per ADR-017 §2 spatial-confidence carve-out — `jurisdiction_binding` has no `confidence` column). S03.11's audit subjects are the entities from S03.6 / S03.7 / S03.8: `regulation_record`, `season_definition`, `license_tag`, `draw_spec`. S03.11 closes the loop on Q11; ADR-017 may need amendments based on actual ingestion outcomes. Working notes from S03.3-S03.10 in `docs/planning/epics/E03-confidence-findings/` are the source material; all delete at m1 tag per ADR-017 §6.
