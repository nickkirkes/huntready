...
**Status:** In Progress (9/13 stories complete; S03.8 closed 2026-05-19 — draw_spec ingestion + S03.7 kind heuristic amendment; Q17 per-HD-allocation-caps opened for M2)
...
**UAT Gating:** S03.3 (UAT cleared 2026-05-08), S03.4 (UAT cleared 2026-05-12), S03.5 (UAT cleared 2026-05-14), S03.6 (UAT: no — verification via SQL row counts in S03.12), S03.7 (data-layer UAT cleared 2026-05-16), S03.8 (UAT: no — verification via SQL in S03.12), S03.10, S03.12 (entity ingestion + binding + milestone exit)
