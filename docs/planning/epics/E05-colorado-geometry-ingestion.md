...
- [ ] Test suite delta: +N tests in `ingestion/tests/test_load_gmus.py` (mirrors S02.2's 435-line `test_load_hds.py` test-suite scope); baseline shifts **1187 → 1187+N at close (post-S05.1 baseline; S05.0 shifted 1166 → 1184 via `test_load_co_state_boundary.py`; S05.1 shifted 1184 → 1187 via the new `TestNoColoradoLeakIntoSharedLib` class)**; document exact N
...
- [ ] Test suite delta documented; baseline preserved at **1187 (post-S05.1) + N (S05.2's delta) + M (S05.5's delta)**
...
- [ ] Test suite delta documented at every story close; **final E05 baseline = 1187 + sum of S05.2-S05.7 per-story deltas** (running history: M1 close 1166 → S05.0 1184 via `test_load_co_state_boundary.py` (+18) → S05.1 1187 via `TestNoColoradoLeakIntoSharedLib` (+3))
