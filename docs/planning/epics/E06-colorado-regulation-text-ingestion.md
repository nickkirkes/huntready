...
- [ ] Per-row text faithful to source PDF; PM-run spot-check on **≥3 of the 10 zones** (e.g., Rocky Mountain NP, Mesa Verde NP, AFA) cross-checks against CPW brochure page 78 — *PM-pending; dev `verbatim_rule` values now populated (operator pass 2026-06-23); PM runs spot-check against brochure page 78 + ticks in follow-up doc-only commit*
