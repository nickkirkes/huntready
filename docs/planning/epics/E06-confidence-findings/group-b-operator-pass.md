...
4. **S06.7 row total in CLAUDE.md / E06 epic is wrong: 8,979 should be 10,979.** The five live-verified counts (2013 + 2470 + 2013 + 2013 + 2470) sum to **10,979**, not the "8,979 entity/link rows" stated in the S06.7 closure narrative (off by exactly 2,000 — a rolled-up-total arithmetic error; the five constituent counts are correct everywhere). The live post-write snapshot sums to 10,979, confirming. **Not a data problem** — the loader wrote the correct rows. Recommend the PM correct "8,979 → 10,979" in CLAUDE.md and the E06 epic S06.7 narrative. (This working note inherited the wrong figure and has been corrected.)
...
- [ ] (Doc hygiene) Correct the S06.7 row total `8,979 → 10,979` in CLAUDE.md + the E06 epic S06.7 narrative per Anomalies #4.
