...
- [x] Row-count guard `_BINDING_COUNT_GUARD_BAND = (552, 1024)` fires BEFORE `db.connect()` per OQ7 discipline; intentionally wide pending T16 (narrow to ±30% after first live run; tracked in working note)[^row-count-correction]
