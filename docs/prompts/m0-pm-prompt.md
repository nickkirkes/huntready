...
3. **S0.3: Create `.env.example`** documenting required environment variables (Supabase URL, secret key, publishable key, `DATABASE_URL`, Mapbox token) with clear placeholders and no real values.
